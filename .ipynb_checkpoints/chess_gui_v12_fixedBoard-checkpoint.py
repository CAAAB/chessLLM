...
ANALYSIS_TIME_LIMIT = .5 # Time for background/move analysis
BEST_MOVE_ANALYSIS_TIME = 5 # Time for "Show Best Move" button click
            ...
            # --- Key Presses ---
                ...
                if input_active:
                    if event.key == pygame.K_RETURN or event.key == pygame.K_KP_ENTER:
                        ...
                        needs_redraw = True
                    elif event.unicode.isdigit(): # Handle numeric input
                        # Limit length to 3 digits (0-959)
                        if len(input_text) < 3:
