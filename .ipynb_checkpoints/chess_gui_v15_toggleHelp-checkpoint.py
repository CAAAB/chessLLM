...
def draw_setup_panel(surface, best_move_button_rect, best_move_button_text, toggle_helpers_button_rect, toggle_helpers_button_text, button_font):
...
def play_chess960_pygame(start_board_number):
    ...
    while running:
        ...
        if needs_redraw:
            ...
            draw_setup_panel(screen, setup_panel_ui_elements["show_best_move_button_rect"], best_move_button_text, setup_panel_ui_elements["toggle_helpers_button_rect"], toggle_helpers_button_text, BUTTON_FONT)
